...
import com.must.nano2.databinding.ItemNoteBinding;
import com.must.nano2.helper.NoteDiffCallback;
        ...
        public void bind(Note note) {
            ...
            binding.cvItemNote.setOnClickListener(v -> {
                Intent intent = new Intent(v.getContext(),
                        InsertUpdateActivity.class);intent.putExtra(InsertUpdateActivity.EXTRA_NOTE, note);
