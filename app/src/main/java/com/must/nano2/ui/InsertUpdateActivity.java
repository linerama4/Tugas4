...
import com.must.nano2.databinding.ActivityInsertUpdateBinding;
import com.must.nano2.helper.DateHelper;
...
public class InsertUpdateActivity extends AppCompatActivity {
    ...
    private boolean isEdit = false;private Note note;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnSubmit.setOnClickListener(view -> {
            ...
            if (title.isEmpty()) {
                binding.edtTitle.setError(getString(R.string.empty));} else if (description.isEmpty()) {
    ...
    private void showAlertDialog(int type) {
        ...
        if (isDialogClose) {
            ...
            dialogMessage = getString(R.string.message_cancel);} else {
